            ...
            <>
                ...
                <div className="modal__ animateModal" id="id01">
                    ...
                    <form className="model_content" method="post">
                        ...
                        />
                        {this.state.email_error != null && <div style={{ color: "red", fontSize: "1rem" }}>{this.state.email_error}</div>}                    <label className="__formLabel" htmlFor="psw"><b>Password</b></label>
                        <input
                            type="password"
                            ...
                            onChange={this.handlechange}
                        />
                        {this.state.password_error != null && <div style={{ color: "red", fontSize: "1rem" }}>{this.state.password_error}</div>}
